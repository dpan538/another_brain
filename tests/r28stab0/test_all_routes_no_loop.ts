...
test("R28STAB0 route matrix serves direct static entries without loops", async () => {
  ...
  for (const route of routes) {
    ...
    assert.ok(html.includes("R28P0") || html.includes("R28MERGE3") || html.includes("R28SHIP0") || html.includes("R28UX5") || html.includes("R28RAG3") || html.includes("R28SURF2") || html.includes("R28ROUT1") || html.includes("R28HOTFIX3") || html.includes("R28HOTFIX2") || html.includes("R28HOTFIX1"), route);
