...
test("event binding is null-safe and avoids direct null.addEventListener", async () => {
  ...
  assert.equal(/contextImportButton\.addEventListener|form\.addEventListener|modelSelfCheckButton\.addEventListener/.test(app), false);
