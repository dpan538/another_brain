...
def main():
    ...
    report = {
        ...
        "candidate_schema": "r27a6_public_instruction_final_answer_only",
    }
    ...
    (ROOT / "docs/r27/R27A6_DISTILLATION_AND_SFT_WORKFLOW.md").write_text(
        "# R27A6 Distillation And SFT Workflow\n\n"
        ...
        "Live teacher probes are disabled by default and require both `--execute-live-teacher` and `R27A6_ALLOW_LIVE_TEACHER=1`. Teacher output is training-time candidate data only, final-answer-only, and never a runtime dependency or personal voice authority.\n",
        encoding="utf-8",
    )
