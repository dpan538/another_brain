...
const ALLOWED_ONE_SHOT_SCRIPTS = new Set([
  ...
  "run:r25ar-repaired-sampler-microcycle-once"
]);
...
const TRAINING_RERUN_PATTERNS = [
  ...
  {
    code: "future_r25u_training_nested_in_routine_gate",
    pattern: /run:[^"\n]*r25u[^"\n]*(?:--allow-small-pilot-training|--allow-architecture-ablation-training)/i
  },
  {
    code: "future_r25v_training_nested_in_routine_gate",
    pattern: /run:[^"\n]*r25v[^"\n]*(?:--allow-small-pilot-training|--allow-architecture-ablation-training|--allow-phase-4-scaled-training)/i
  },
  {
    code: "future_r25x_training_nested_in_routine_gate",
    pattern: /run:[^"\n]*r25x[^"\n]*(?:--allow-small-pilot-training|--allow-data-refinement-training|--allow-architecture-ablation-training|--allow-phase-4-scaled-training)/i
  },
  {
  ...
  {
    code: "future_r25ab_phase4_training_nested_in_routine_gate",
    pattern: /run:[^"\n]*r25ab[^"\n]*(?:--allow-phase4-design|--allow-phase-4-scaled-training|--allow-product-model-training)/i
  },
  {
  ...
  {
    code: "future_r25ar_training_nested_in_routine_gate",
    pattern: /run:[^"\n]*r25ar[^"\n]*(?:--allow-small-pilot-training|--allow-decoder-training|--allow-bounded-decoder-pilot-training|--allow-phase-4-scaled-training|--allow-product-model-training|--allow-training)/i
  }
];
