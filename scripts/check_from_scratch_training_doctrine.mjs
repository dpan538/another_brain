...
const ACTIVE_RE = /^(README\.md|DEPLOYMENT\.md|DATA_CARD\.md|docs\/R25.*\.md|static_llm\/(candidate_decisions|release_decisions|request_pack|ASSET_LAYOUT\.md).+|training\/from_scratch\/.+|scripts\/(build_static_llm_candidate_matrix|report_from_scratch_training_progress|check_no_active_named_model_candidate|check_no_slm_product_target|build_tiny_decoder_toy_dataset|run_tiny_decoder_toy_overfit|eval_tiny_decoder_toy_overfit|check_tiny_decoder_toy_artifacts_untracked|check_r25k_toy_overfit_sanity|check_r25k_toy_overfit_history|generate_r25l_expanded_llm_corpus|validate_r25l_expanded_corpus|check_r25l_corpus_contamination|report_r25l_corpus_coverage|plan_small_decoder_pilot|run_small_decoder_pilot|check_small_decoder_pilot_plan|check_r25l_corpus_pilot_plan|check_small_decoder_numeric_backend|build_small_decoder_pilot_dataset|eval_small_decoder_pilot|eval_small_decoder_pilot_r25p|eval_small_decoder_pilot_r25s|eval_small_decoder_pilot_r25v|eval_small_decoder_pilot_r25y|eval_small_decoder_pilot_r25ac|eval_small_decoder_pilot_r25ao|eval_small_decoder_pilot_r25ar|eval_r25ac_chinese_personal_breakdown|eval_r25ao_chinese_personal_breakdown|eval_r25ar_mixed_repair_breakdown|check_r25ac_chinese_personal_microcycle_history|check_r25ar_repaired_sampler_microcycle_history|analyze_r25ac_microcycle_results|audit_r25ac_personal_target_coverage|report_chinese_personal_corpus_gap|validate_r25ae_corpus_expansion_design|report_r25ad_next_step_decision|check_small_decoder_pilot_artifacts_untracked|report_small_decoder_pilot_gate_snapshot|check_r25m_small_decoder_pilot|check_r25m_small_pilot_history|check_training_approval_markers|check_no_training_in_routine_gates|check_chinese_personal_training_direction|audit_chinese_first_corpus_mix|analyze_small_decoder_pilot_outputs|eval_small_decoder_pilot_heldout|report_small_pilot_regression_snapshot|report_r25n_next_pilot_decision|check_r25n_small_pilot_evaluation|plan_second_small_decoder_pilot|validate_small_decoder_checkpoint_schema|eval_small_decoder_pilot_replay_heldout|compare_small_pilot_history|check_r25o_second_pilot_design|check_r25p_second_small_pilot|check_r25s_data_first_pilot_history|check_r25v_architecture_ablation_history|check_r25y_data_regularization_history|check_r25w_r25v_analysis|audit_r25x_training_data_quality|analyze_r25s_best_pilot_rows|validate_r25y_data_regularization_design|report_r25x_phase3_review|check_r25x_phase3_review|analyze_r25p_pilot_results|check_r25p_replay_determinism|eval_r25p_heldout_breakdown|report_r25q_next_step_decision|plan_r25s_balanced_pilot_dataset|validate_r25s_pilot_design|report_r25r_decision|check_r25r_data_first_pilot_design|analyze_r25s_pilot_results|eval_r25s_heldout_breakdown|compare_r25p_r25s_generalization|report_r25t_next_step_decision|analyze_r25v_pilot_results|eval_r25v_heldout_breakdown|compare_data_first_vs_architecture_ablation|report_r25w_next_step_decision|check_phase4_scaled_training_readiness|evaluate_phase4_static_envelope|report_r25aa_phase3_pause_decision|check_r25aa_phase4_readiness_review|plan_architecture_ablation|report_r25u_phase_decision|check_r25u_phase3_exit_and_ablation_plan|analyze_r25y_pilot_results|eval_r25y_heldout_breakdown|compare_r25y_data_regularization|report_r25z_next_step_decision|check_r25z_r25y_analysis|analyze_r25ao_root_cause|analyze_r25ao_mixed_en_weakness|analyze_r25ao_high_loss_families|simulate_r25aq_sampler_variants|report_r25aq_next_step_decision|analyze_r25ar_microcycle_results|compare_r25ar_vs_r25ao_regression|analyze_phase3_pilot_regression_trend|analyze_r25ar_high_risk_family_regression|analyze_r25ar_training_intensity_capacity|report_r25as_next_step_decision)\.mjs|scripts\/train_small_decoder_pilot\.py|scripts\/eval_small_decoder_replay_heldout\.py|package\.json)$/;
...
const allowContext = /not|no |never|without|forbidden|rejected|reject|comparison|compatibility|baseline|fixture|legacy|historical|do not|must not|cannot|is not|are not|only as|warning|non-goal|avoid|risk|rollback|trigger|failure|any claim|treating|toy-only|toy sanity|pipeline mechanics|ignored artifact|ignored artifacts|no tracked weights|formal_training":false|formal_product_training":false|long_term_training":false|release_checkpoint":false|product_model":false|private_raw_data_allowed": false|chain_of_thought_allowed": false|eval_prompt_training_allowed": false|external_llm_generation_allowed": false|allow_private_data_sources": false|allow_external_llm_generation": false|R25L|R25M|R25N|R25O|R25P|R25Q|R25R|R25S|R25T|R25U|R25V|R25W|R25X|R25Y|R25Z|R25AA|R25AB|R25AC|R25AD|R25AE|R25AF|R25AG|R25AH|R25AI|R25AJ|R25AK|R25AL|R25AM|R25AN|R25AO|R25AP|R25AQ|R25AR|R25AS|small decoder pilot plan|small decoder pilot planning|bounded small|bounded pilot|bounded second pilot|bounded Chinese-first personal|Chinese-first personal micro-cycle|chinese personal microcycle|Chinese-personal corpus expansion|corpus-expansion review|second bounded pilot|small decoder pilot is bounded|second pilot design|pilot analysis|data-first design|data regularization|data-regularization|balanced sampling|Chinese-first sampling|personal target coverage|repaired sampler|mixed repair|R25S template|R25U template|R25V template|R25X template|R25Y template|R25AA template|R25AB template|R25AC template|R25AE template|R25AP template|R25AQ template|R25AR template|R25AS template|architecture ablation design|architecture ablation analysis|phase3 decision ledger|phase3 review ledger|phase3 final review ledger|phase3 final review ledger|phase3 exit criteria|phase 3 exit criteria|phase4 readiness|phase_4 readiness|phase4 static envelope|static envelope review|generalization comparison|data-vs-architecture|data quality audit|best-pilot row analysis|pilot design|replay determinism|held-out breakdown|replayable checkpoint protocol|skips by default|planned_no_training|training_will_run":false|small_pilot_training_ran|pilot_training_progress_percent|approval marker|approval markers|approval template|approved:false|consumed|one-shot|fresh approval|history-only|held-out structural|heldout replay|does not run training|no-training routine gate|routine gates cannot rerun|scale_not_approved|phase_4 scaled training is not approved|phase_4_scaled_training_approved: false|phase4_scaled_training_approved": false|training_rerun: false|PURGED_CANDIDATE_RE|FINAL_STRATEGY_RE|FORBIDDEN_PRODUCT_RE|BACKEND_RE|RegExp/i;
...
async function main() {
  ...
  const requiredFiles = [
    ...
    "docs/R25V_ARCHITECTURE_ABLATION_PILOT_RUN.md",
    "docs/R25V_ABLATION_HELDOUT_EVAL.md",
    "scripts/eval_small_decoder_pilot_r25v.mjs",
    "scripts/check_r25v_architecture_ablation_history.mjs",
    "training/from_scratch/phase3_decision_ledger.json",
    "training/from_scratch/APPROVE_R25X_FUTURE_PILOT.template.json",
    "docs/R25W_PHASE3_DECISION_LEDGER.md",
    "docs/R25W_R25V_ANALYSIS_AND_DECISION.md",
    "docs/R25W_DATA_FIRST_VS_ARCHITECTURE_ABLATION.md",
    "scripts/analyze_r25v_pilot_results.mjs",
    "scripts/eval_r25v_heldout_breakdown.mjs",
    "scripts/compare_data_first_vs_architecture_ablation.mjs",
    "scripts/report_r25w_next_step_decision.mjs",
    "scripts/check_r25w_r25v_analysis.mjs",
    ...
    "docs/R25X_PHASE3_REVIEW.md",
    "docs/R25X_PHASE3_REVIEW_AND_DATA_REGULARIZATION.md",
    "docs/R25X_R25Y_APPROVAL_BOUNDARY.md",
    "scripts/audit_r25x_training_data_quality.mjs",
    "scripts/analyze_r25s_best_pilot_rows.mjs",
    "scripts/validate_r25y_data_regularization_design.mjs",
    "scripts/report_r25x_phase3_review.mjs",
    "scripts/check_r25x_phase3_review.mjs",
    ...
    "docs/R25Y_DATA_REGULARIZATION_PILOT_RUN.md",
    "docs/R25Y_REGULARIZED_HELDOUT_EVAL.md",
    "scripts/eval_small_decoder_pilot_r25y.mjs",
    "scripts/check_r25y_data_regularization_history.mjs",
    "training/from_scratch/phase3_decision_ledger.r25z.json",
    "training/from_scratch/APPROVE_R25AA_NEXT_STEP.template.json",
    "docs/R25Z_R25Y_ANALYSIS_AND_DECISION.md",
    "docs/R25Z_PHASE3_DECISION_REVIEW.md",
    "scripts/analyze_r25y_pilot_results.mjs",
    "scripts/eval_r25y_heldout_breakdown.mjs",
    "scripts/compare_r25y_data_regularization.mjs",
    "scripts/report_r25z_next_step_decision.mjs",
    "scripts/check_r25z_r25y_analysis.mjs",
    ...
    "docs/R25AA_PHASE3_FINAL_REVIEW.md",
    "docs/R25AA_PHASE3_PAUSE_AND_REVIEW.md",
    "docs/R25AA_PHASE4_READINESS_REVIEW.md",
    "docs/R25AA_PHASE4_STATIC_ENVELOPE_REVIEW.md",
    "scripts/evaluate_phase4_static_envelope.mjs",
    "scripts/report_r25aa_phase3_pause_decision.mjs",
    "scripts/check_r25aa_phase4_readiness_review.mjs",
    ...
    "scripts/analyze_r25ac_microcycle_results.mjs",
    "scripts/audit_r25ac_personal_target_coverage.mjs",
    "scripts/report_chinese_personal_corpus_gap.mjs",
    "scripts/validate_r25ae_corpus_expansion_design.mjs",
    "scripts/report_r25ad_next_step_decision.mjs"
  ];
