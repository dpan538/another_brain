...
VERSION = "r28hotfix0-runtime-ui-activation"
...
def build_route_runtime_audit() -> dict[str, Any]:
    ...
    checks = {
        "root_contains_hotfix_marker": "R28HOTFIX0" in root_html,
        "root_redirects_to_chat_slash": "/another_brain_chat/" in root_html,
        ...
        "chat_no_slash_static_fallback_exists": "R28HOTFIX0" in chat_no_slash_html and "/another_brain_chat/" in chat_no_slash_html,
        "vercel_redirects_no_slash_to_slash": chat_redirect.get("destination") == "/another_brain_chat/",
        "query_preserved_by_static_redirects": "URLSearchParams(window.location.search)" in root_html and "URLSearchParams(window.location.search)" in chat_no_slash_html,
        "app_uses_hotfix_runtime_import": "browser_runtime.js?v=r28hotfix0-runtime-ui-activation" in app_js,
        ...
        "runtime_uses_cache_busted_worker": "runtime_worker.js?v=r28hotfix0-runtime-ui-activation" in runtime_js,
        ...
        "runtime_mode_hotfix_version": runtime_mode.get("ui_version") == VERSION,
        "asset_manifest_hotfix_version": asset_manifest.get("ui_version") == VERSION,
    ...
    return {
        ...
        "version": VERSION,
        "routes": {
            "/": "web/index.html -> /another_brain_chat/",
            "/another_brain_chat": "vercel redirect plus web/another_brain_chat.html fallback",
            "/another_brain_chat/": "web/another_brain_chat/index.html",
            "/another_brain_chat?message=...": "canonicalized to /another_brain_chat/?message=...",
