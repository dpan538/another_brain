...
def main() -> int:
    ...
    checks = {
        ...
        "culture_awareness": run_command("culture_awareness", ["node", "scripts/eval_culture_awareness.mjs", "--out", "artifacts/release/culture_awareness_report.json"]),
    ...
    tests = {
        ...
        "culture_awareness": gate_result(checks["culture_awareness"], {"summary": check_payload(checks["culture_awareness"], ROOT / "artifacts" / "release" / "culture_awareness_report.json").get("summary")}),
