...
ACCEPTED_UI_VERSIONS = ("r28ux4-visible-preview-ui", "r28hotfix0-runtime-ui-activation", "r28hotfix1-route-loop-free-runtime", "r28hotfix2-nonblocking-selfcheck", "r28hotfix3-q4-asset-path-fix", "r28rout1-fuzzy-intent-surfaces", "r28surf2-anchor-informed-answer-surfaces", "r28rag3-lightweight-affective-rag")
PROCESS_MARKERS = ("过程摘要", "static_q4_experimental", "exact_runtime_tokenizer")
BUILD_MARKERS = ("R28UX4", "R28HOTFIX0", "R28HOTFIX1", "R28HOTFIX2", "R28HOTFIX3", "R28ROUT1", "R28SURF2", "R28RAG3")
