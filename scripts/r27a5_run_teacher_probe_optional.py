...
args = ap.parse_args()
enabled = args.execute_live_teacher and os.environ.get("R27A5_ALLOW_LIVE_TEACHER") == "1"
has_provider = bool(args.provider or os.environ.get("R27A5_TEACHER_PROVIDER"))
status = "disabled_by_default"
if args.execute_live_teacher and not enabled:
    status = "blocked_requires_R27A5_ALLOW_LIVE_TEACHER"
...
report = {
    ...
    "requires_flag": True,
    "requires_env": "R27A5_ALLOW_LIVE_TEACHER=1",
    "max_requests": args.max_requests,
    "max_output_tokens": args.max_output_tokens,
    "provider_configured": has_provider,
    "stores_final_answer_only": True,
}
out = Path("artifacts/r27a5/reports/live_teacher_probe_report.json")
