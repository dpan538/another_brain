...
const R25AB_SURFACE = [
  ...
  "docs/R25AS_R25AR_ANALYSIS_AND_DECISION.md",
  "docs/R25AS_R25AR_VS_R25AO_REGRESSION.md",
  "docs/R25AS_PHASE3_PILOT_REGRESSION_TREND.md",
  "docs/R25AS_HIGH_RISK_FAMILY_REGRESSION.md",
  "docs/R25AS_TRAINING_INTENSITY_CAPACITY_REVIEW.md",
  "docs/R25AS_NEXT_STEP_BOUNDARY.md",
  ...
  "training/from_scratch/APPROVE_R25AT_PHASE3_REVIEW_NEXT_STEP.template.json",
  ...
  "scripts/analyze_r25ar_microcycle_results.mjs",
  "scripts/compare_r25ar_vs_r25ao_regression.mjs",
  "scripts/analyze_phase3_pilot_regression_trend.mjs",
  "scripts/analyze_r25ar_high_risk_family_regression.mjs",
  "scripts/analyze_r25ar_training_intensity_capacity.mjs",
  "scripts/report_r25as_next_step_decision.mjs",
  "scripts/check_r25ar_repaired_sampler_microcycle_history.mjs",
