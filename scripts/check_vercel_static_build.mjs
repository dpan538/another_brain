...
async function main() {
  ...
  const rootHasR28hotfix1DirectApp =
    ...
    /exact_runtime_tokenizer/.test(index) &&
    /检查本地模型路径/.test(index) &&
    /\/another_brain_chat\/app\.js\?v=(r28hotfix1-route-loop-free-runtime|r28hotfix2-nonblocking-selfcheck|r28hotfix3-q4-asset-path-fix|r28rout1-fuzzy-intent-surfaces|r28surf2-anchor-informed-answer-surfaces|r28rag3-lightweight-affective-rag|r28ux5-chat-dashboard-split|r28ship0-unified-q4-mount)/.test(index);
