...
def run_gate(root: Path = ROOT) -> dict:
    ...
    checks = [
        ...
        check(
            ...
            or "/another_brain_chat/app.js?v=r28p0e-real-browser-q4-forward" in index
            or "/another_brain_chat/app.js?v=r28p0e-real-browser-q4-forward" in root_index
            or "/another_brain_chat/app.js?v=r28p0d-browser-compat-no-fallback-choice" in index
            or "/another_brain_chat/app.js?v=r28p0d-browser-compat-no-fallback-choice" in root_index
            or "/another_brain_chat/app.js?v=r28p0c-coldstart-mobile-chat" in index
            or "/another_brain_chat/app.js?v=r28p0c-coldstart-mobile-chat" in root_index,
