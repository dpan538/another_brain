...
def main():
    ...
    marker["consumed_by_phase"] = "R27A4"
    marker["consumed_by_commit"] = "pending_r27a4_commit"
    marker["consumed_at_utc"] = now_utc()
    marker["consumed_reason"] = "R27A4 bounded engineering campaign completed or safely stopped; future runs require a new approval marker."
