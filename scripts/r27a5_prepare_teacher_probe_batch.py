...
def main():
    ...
    out = ROOT / "artifacts/r27a5/distillation/live_teacher_probe_batch.json"
    ...
    (ROOT / "artifacts/r27a5/reports/live_teacher_prepare_report.json").write_text(json.dumps(report, ensure_ascii=False, indent=2, sort_keys=True), encoding="utf-8")
