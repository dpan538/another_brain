...
const tests = {
  ...
  test_no_production_change() {
    ...
    const allowed = /^(config\/r29p0_|docs\/R29P0_|evals\/r29p0_|prompts\/r29p0_|reports\/r29p0_pairwise_oracle_engineering_receipt\.json|scripts\/r29p0_|scripts\/(?:check_hybrid_lab_isolation|r29b2m_r4h_no_backend_production_gate)\.mjs|src\/hybrid_runtime\/r29p0_|src\/hybrid_runtime\/protected_feature_signature\.ts|tests\/r29p0\/|package\.json)/u;
