...
CASES = [
    ("help_start_001", "help_start", "我该怎么开始？", "直接问。"),
    ("help_start_002", "help_start", "怎么开始？", "直接问。"),
    ("help_start_003", "help_start", "怎么用？", "直接问。"),
    ("help_start_004", "help_start", "怎么使用？", "直接问。"),
    ("help_start_005", "help_start", "这个网页怎么用？", "直接问。"),
    ("help_features_001", "help_features", "你有什么功能？", "聊天、短答、改短句子。不知道会停下。"),
    ("help_features_002", "help_features", "你能做什么？", "聊天、短答、改短句子。不知道会停下。"),
    ("help_features_003", "help_features", "功能是什么？", "聊天、短答、改短句子。不知道会停下。"),
    ("help_examples_001", "help_examples", "可以问什么？", "问：你是谁？能做什么？也可以丢一个想法。"),
    ("help_examples_002", "help_examples", "可以问哪些？", "问：你是谁？能做什么？也可以丢一个想法。"),
    ("help_examples_003", "help_examples", "给我几个问题例子？", "问：你是谁？能做什么？也可以丢一个想法。"),
    ...
    ("help_privacy_004", "help_privacy", "会上传吗？隐私安全吗？", "公开版本不需要云端推理，也不该说出私人文件、证件、账号、地址或原始材料。"),
