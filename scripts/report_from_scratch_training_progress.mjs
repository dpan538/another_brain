...
async function main() {
  ...
  const report = {
    ...
    r25ac_design_status: r25acDesignOk ? "designed_not_approved_chinese_personal_microcycle" : "not_present_or_needs_review",
