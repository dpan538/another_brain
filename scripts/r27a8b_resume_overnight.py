...
def main():
    ...
    args = ap.parse_args()
    report = run_overnight(args.campaign_id, launch_config="artifacts/r27a7r2/go/R27A8B_READY.json", run_label=args.campaign_id, resume=True)
    ...
    if not report.get("ok"):
        raise SystemExit("r27a8b_resume_not_ok")
