...
const SELF_CHECK_DEEP_TIMEOUT_MS = 300000;
const SELF_CHECK_DEEP_TIMEOUT_MAX_MS = 360000;
...
export class BrowserChatRuntime {
  ...
  async selfCheckModelPath(options = {}) {
    ...
    const shardProbeTimeoutMs = Math.min(Math.max(Number(options.shardTimeoutMs || SELF_CHECK_SHARD_PROBE_TIMEOUT_MS), 100), 30000);
