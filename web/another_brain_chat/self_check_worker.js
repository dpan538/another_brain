import { generateStaticQ4Draft } from "./q4_worker_runtime.js?v=r28ux5-chat-dashboard-split";
...
async function handleSelfCheck(message = {}) {
  ...
  try {
    ...
    const generation = await generateStaticQ4Draft(message.prompt || "R28UX5 q4 path smoke", {
