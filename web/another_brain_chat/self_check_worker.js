import { generateStaticQ4Draft } from "./q4_worker_runtime.js?v=r28hotfix2-nonblocking-selfcheck";
...
async function handleSelfCheck(message = {}) {
  ...
  try {
    ...
    const generation = await generateStaticQ4Draft(message.prompt || "R28HOTFIX2 q4 path smoke", {
