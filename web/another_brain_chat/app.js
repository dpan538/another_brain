...
const DEFAULT_DELIVERY_CONFIG = Object.freeze({
  ...
  candidate_warning: "未加载真实模型 assets；product-path candidate 仅 metadata/dry-run，当前使用 fallback / synthetic 路径。",
  ...
  non_product_warning: "当前只是 prelaunch engineering candidate，不是 product model；R28P1 demo_static release-candidate gate 只展示 engineering metadata，不是 browser 或 release checkpoint admission。"
});
