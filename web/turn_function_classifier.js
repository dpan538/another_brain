...
export function classifyTurnFunction({ query = "", session = {}, userTurn = {}, binding = {} } = {}) {
  ...
  if (/(很喜欢你.*(文学|诗歌|艺术|形式|设计|电影|镜头|语言|翻译|意义|饮食|烹饪|味觉|法律|正义|规则|照护|医学人文|身体|病房|心理|精神分析|情绪|梦|戏剧|舞台|表演|历史|记忆|档案|科学|叙事|城市|空间|技术|伦理|行动|教育|学习|经验|经济|制度|劳动).*努力|喜欢你在.*(文学|诗歌|艺术|形式|设计|电影|镜头|语言|翻译|意义|饮食|烹饪|味觉|法律|正义|规则|照护|医学人文|身体|病房|心理|精神分析|情绪|梦|戏剧|舞台|表演|历史|记忆|档案|科学|叙事|城市|空间|技术|伦理|行动|教育|学习|经验|经济|制度|劳动).*努力|你在.*(文学|诗歌|艺术|形式|设计|电影|镜头|语言|翻译|意义|饮食|烹饪|味觉|法律|正义|规则|照护|医学人文|身体|病房|心理|精神分析|情绪|梦|戏剧|舞台|表演|历史|记忆|档案|科学|叙事|城市|空间|技术|伦理|行动|教育|学习|经验|经济|制度|劳动).*努力|喜欢你把.*(音乐|文学|诗歌|艺术|形式|设计|电影|镜头|语言|翻译|意义|饮食|烹饪|味觉|法律|正义|规则|照护|医学人文|身体|病房|心理|精神分析|情绪|梦|戏剧|舞台|表演|历史|记忆|档案|科学|城市|技术|伦理|教育|经济|制度).*(连|放|想)|喜欢你在.*(诗性|文学|艺术|形式|设计|电影|镜头|语言|翻译|意义|饮食|烹饪|味觉|法律|正义|规则|照护|医学人文|身体|病房|心理|精神分析|情绪|梦|戏剧|舞台|表演|历史|记忆|档案|科学|叙事|城市|空间|技术|伦理|行动|教育|学习|经济|制度).*尝试)/.test(text)) {
    return baseResult({
  ...
  if (/(羡慕|让我想到了?|想到童年|想起童年|比较喜欢|有点怀念|把普通物件变成问题|重新看普通东西|羡慕.*(观察|街道|工具|行动|判断|证据|公共空间|学习|课堂|经验|劳动|制度|镜头|翻译|说法|命名|味道|餐桌|手艺|规则|公平|裁判|照护|倾听|身体|病房|诊断|梦|情绪|记忆|理解自己|台词|表演|停顿|档案|史料|时间)|想到.*(小时候|小时候的|童年|记忆))/.test(text)) {
    return baseResult({
  ...
  if (/(和.*(文学|诗歌|诗|小说).*(很像|有点像|有一点像|也有点像|也有一点像|差不多|相近)|像.*(文学|诗歌|诗|小说)|不只是流行音乐|文学性|很短的形式写故事|有点像诗|有一点像诗|像是在写故事|叙事感很强)/.test(text)) {
    return baseResult({
  ...
  if (/(像舞台剧|有点像舞台剧|这其实.*舞台剧|细节和冲突|场景和冲突|镜头和冲突|镜头.*冲突|比较有镜头|像审判现场|像餐桌场景|像剧场|像历史现场|像档案现场)/.test(text) && !/(相似|共同|相似性|注意到|能看到|你知道|是什么|是谁|你怎么看|你觉得|怎么样|好不好|重点|重要)/.test(text)) {
    return baseResult({
      turn_function: "analogy_statement",
      stance_requirement: "light_judgment",
      judgment_axis: "form",
  ...
  if (/(和.*(设计|建筑|摄影|电影|镜头|语言|翻译|命名|饮食|烹饪|味觉|餐桌|法律|正义|判例|规则|照护|医学人文|病房|身体|心理学|精神分析|梦|情绪|戏剧|舞台|表演|历史|记忆|档案|史料|工具|界面|城市|规划|科学观察|实验|政治|伦理|教育|课堂|学习|经济|市场|劳动).*(很像|有点像|有一点像|也有点像|也有一点像|差不多|相近)|像.*(设计|建筑|摄影|电影|镜头|语言|翻译|命名|饮食|烹饪|味觉|餐桌|法律|正义|判例|规则|照护|医学人文|病房|身体|心理学|精神分析|梦|情绪|戏剧|舞台|表演|历史|记忆|档案|史料|工具|界面|城市|规划|科学观察|实验|政治|伦理|教育|课堂|学习|经济|市场|劳动)|不只是.*(艺术|形式|技术|科学|教育|经济|语言|饮食|法律|照护|心理|戏剧|历史).*也.*(设计|建筑|摄影|电影|镜头|城市|文学|经验|制度|翻译|餐桌|正义|身体|记忆|舞台)|这个其实和(设计|教育|经济|语言|电影|饮食|法律|照护|心理学|戏剧|历史)(很像|有点像|有一点像|也有点像|也有一点像|差不多|相近))/.test(text)) {
    return baseResult({
      turn_function: "analogy_statement",
      stance_requirement: "light_judgment",
      judgment_axis: "form",
                ...
                : /(教育|课堂|学习)/.test(text)
                  ...
                  : /(经济|市场|劳动)/.test(text)
                    ...
                    : /(语言|翻译|命名|意义)/.test(text)
                      ? "language_meaning"
                      : /(饮食|烹饪|味觉|餐桌)/.test(text)
                        ? "food_craft"
                        : /(法律|正义|判例|规则)/.test(text)
                          ? "law_justice"
                          : /(照护|医学人文|病房|身体|诊断)/.test(text)
                            ? "care_relation"
                            : /(心理学|精神分析|梦|情绪|自我理解)/.test(text)
                              ? "psychology_memory"
                              : /(戏剧|舞台|表演|剧场)/.test(text)
                                ? "theater_performance"
                                : /(历史|记忆|档案|史料)/.test(text)
                                  ? "history_memory"
                    : "design_form",
      confidence: 0.88,
  ...
  if (/(像舞台剧|有点像舞台剧|这其实.*舞台剧|细节和冲突|场景和冲突|镜头和冲突|镜头.*冲突|比较有镜头|像审判现场|像餐桌场景)/.test(text) && !/(相似|共同|相似性|注意到|能看到|你知道|是什么|是谁|你怎么看|你觉得|怎么样|好不好|重点|重要)/.test(text)) {
    return baseResult({
      turn_function: "analogy_statement",
      stance_requirement: "light_judgment",
      judgment_axis: "form",
  ...
  if (/(代表作(?:品)?和(?:作家|作者|艺术家)|代表作(?:品)?.*(作家|作者|艺术家|导演)|(?:作家|作者|艺术家|导演).*代表作(?:品)?|电影作者.*代表作品|代表人物|关键人物|经典文本|代表入口|入口能列|列举.{0,8}(三个|三位|几个)|能列(?:举)?.*(作家|作者|代表作|代表作品|艺术家|导演|人物|文本|作品|入口)|列.{0,4}(三个|三位).*(作家|作者|作品|艺术家|导演|人物|文本|入口)|(三个|三位).*(作家|作者|作品|艺术家|导演|人物|文本|入口).*(列|列一下|列举))/.test(text)) {
    return baseResult({
  ...
  if (/(专辑.*单曲|单曲.*专辑|现成品.*绘画|绘画.*现成品|照片.*绘画|绘画.*照片|镜头.*剪辑|剪辑.*镜头|食谱.*烹饪|烹饪.*食谱|食谱.*调味|调味.*食谱|味觉.*叙事|叙事.*味觉|规则.*判例|判例.*规则|法律.*正义|正义.*法律|诊断.*照护|照护.*诊断|症状.*叙事|叙事.*症状|倾听.*解释|解释.*倾听|梦.*记忆|记忆.*梦|心理.*文学|文学.*心理|排练.*演出|演出.*排练|台词.*表演|表演.*台词|史料.*叙事|叙事.*史料|档案.*叙事|叙事.*档案|档案.*记忆|记忆.*档案|建筑.*海报|海报.*建筑|观察.*实验|实验.*观察|算法.*界面|界面.*算法|规划.*街道|街道.*规划|行动.*理论|理论.*行动|教.*学|学.*教|学习.*训练|训练.*学习|市场.*计划|计划.*市场|市场.*制度|制度.*市场|劳动.*资本|资本.*劳动|命名.*翻译|翻译.*命名|语言.*意义|意义.*语言).*(区别|不同|创作模式|创作方式|工作模式|差别|差在哪里)|创作模式.*(专辑|单曲|现成品|绘画|摄影|电影|镜头|剪辑|饮食|烹饪|照护|心理|戏剧|舞台|历史|叙事|观察|实验|算法|界面)|创作方式.*(专辑|单曲|现成品|绘画|摄影|电影|镜头|食谱|烹饪|调味|照护|心理|戏剧|舞台|叙事)|工作模式.*(观察|实验|算法|界面|规划|街道|学习|训练|市场|计划|制度|劳动|资本|命名|翻译|语言|食谱|烹饪|调味|规则|判例|照护|诊断|梦|记忆|排练|演出|史料|叙事|档案|记忆)/.test(text)) {
    return baseResult({
            ...
            : /(规划|街道|城市)/.test(text)
              ...
              : /(学习|训练|教育|教学)/.test(text)
                ...
                : /(市场|计划|劳动|资本)/.test(text)
                  ...
                  : /(语言|翻译|命名|意义)/.test(text)
                    ? "language_method"
                    : /(食谱|烹饪|味觉|餐桌)/.test(text)
                      ? "food_method"
                      : /(规则|判例|法律|正义)/.test(text)
                        ? "law_method"
                        : /(诊断|照护|症状|护理|临床|病房)/.test(text)
                          ? "care_method"
                          : /(梦|心理|潜意识|情绪|自我理解)/.test(text)
                            ? "psychology_method"
                            : /(排练|演出|戏剧|舞台|表演)/.test(text)
                              ? "theater_method"
                              : /(史料|叙事|档案|记忆|历史)/.test(text)
                                ? "history_method"
                  : "media_form",
      confidence: 0.91,
  ...
  if (/(还有其他.*(歌手|作家|作品|导演|电影|饮食|料理|法律|法学|照护|医学人文|心理学|精神分析|戏剧|舞台|历史|史学|科学家|思想家|城市|建筑|工具|教育家|经济学|语言学|哲学|方向).*推荐|推荐.*(歌手|作家|作品|导演|电影|饮食|料理|法律|法学|照护|医学人文|心理学|精神分析|戏剧|舞台|历史|史学|科学家|思想家|城市|建筑|工具|教育家|经济学|语言学|哲学|方向)|可以推荐|还能听谁|还有谁|还能看谁|还有什么入口)/.test(text)) {
    return baseResult({
  ...
  if (/(讲的真是|真的.*(童年|爱情|乡愁|进步|效率|客观|自由|训练|市场|故事|翻译|意义|好吃|味道|公平|规则|症状|诊断|梦|情绪|剧情|表演|发生过|史料)|真是在讲|是不是.*讲|它讲的是|叫.*童年.*讲童年|只是在开玩笑|只是开玩笑|只是记录现实|只是记录|真的只是|只是.*(效率|进步|客观|工具|训练|市场|故事|翻译|意义|好吃|味道|公平|规则|症状|诊断|梦|情绪|剧情|表演|发生过|史料)|真的是.*(进步|效率|客观|自由|训练|市场|故事|翻译|意义|好吃|味道|公平|规则|症状|诊断|梦|情绪|剧情|表演|发生过|史料)|(童年|进步|效率|客观|自由|训练|市场|故事|翻译|意义|好吃|味道|公平|规则|症状|诊断|梦|情绪|剧情|表演|发生过|史料).*真的是)/.test(text)) {
    return baseResult({
  ...
  if (/(你觉得|你怎么看|你如何看|怎么样|好不好).*(歌|作品|文学|诗|专辑|单曲|电影|镜头|语言|翻译|饮食|料理|烹饪|味觉|法律|正义|判例|公平|照护|医学|身体|心理|精神分析|情绪|戏剧|舞台|表演|历史|记忆|档案|他|她|它)|你觉得.*(重点|重要|厉害|判断)/.test(text)) {
    return baseResult({
  ...
  if (/(回到|说回|回头说|再回到|回过头看|回到刚才|回到前面)/.test(text) && !/(你是谁|对话框|鳄鱼|复制体)/.test(text)) {
    return baseResult({
      turn_function: "topic_reentry",
      stance_requirement: /(为什么|特别|重要|厉害|好不好|怎么样)/.test(text) ? "light_judgment" : "none",
      judgment_axis: /(声音|嗓音|唱法|歌声|歌|歌曲|专辑|单曲|音乐)/.test(text) ? "craft" : "relation",
      bridge_target: "previous_topic",
      confidence: active ? 0.9 : 0.82,
      reasons: ["explicit_topic_reentry"]
    });
  }
